...
public class AIDriver : MonoBehaviour
{
    ...
    //IA
    public DriveMode driveMode = DriveMode.OneWay;
    ...
    //Event 1
    public delegate void LastWaypointHandler(AIEventArgs2 e);
    ...
    void Awake () {
        ...
        aiRespawnScript = gameObject.GetComponent("AIRespawn") as AIRespawn;        
    ...
    void Start ()
    {
        ...
        if (useObstacleAvoidance)
        {
            ...
            frontCollider.transform.rotation = transform.rotation; frontCollider.transform.localScale = new Vector3(frWheel.localPosition.x * 2 + 0.1f, 0.05f, 0.05f);
	    ...
	    if (currentWaypoint < waypoints.Count){
            ...
            if (moveDirection.sqrMagnitude < sqrDistanceToWaypoint)
            {
                ...
                if (currentWaypoint >= waypoints.Count)
                {
                    ...
                    {
                        AIEventArgs2 e = new AIEventArgs2();
    ...
    {        
        ...
        currentAngle = SteeringDecision(leftSideDistance, rightSideDistance, leftDistance, rightDistance, frontMinDistance, frontContact, steeringMode);
